'''
DALES Dataloader (Modified from SparseConvNet Dataloader)
Written by Li Jiang, modified by John Carr
'''
...
#            xyz = self.elastic(xyz, 20 * self.scale // 50, 160 * self.scale / 50)
            xyz = self.elastic(xyz, 6, 40 * self.scale / 50)
            xyz = self.elastic(xyz, 20, 160 * self.scale / 50)
